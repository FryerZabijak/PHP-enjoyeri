...
export default function Tipy() {
  return (
    <div id="tipy" className="md:text-center" data-aos="fade-up">
      <h2 className="font-medium">Nezoufejte, pokud to jde těžce</h2>
      <h3 className="font-bold text-4xl">3 Tipy jak začít s PHP</h3>
      <div className="grid grid-cols-2 gap-4 mt-10 md:grid-cols-1">
        <div className="grid grid-cols-1 gap-12 pr-8 md:mx-16">
